...
contract LOLToken {
    ...
    string public symbol = "LOLcent"; // Указываем символ токена
    uint8 public decimals = 8; // Указываем количество десятичных чисел
    uint256 public totalSupply;
    uint256 public maxSupply = 1000000 * (10**8); // Указываем максимальное количество токенов
    ...
    function mint(address to, uint256 value) public returns (bool success) {
        ...
        require(value * 10**decimals <= maxSupply, "Exceeds maximum supply"); // Условие для максимального количества эмиссии
